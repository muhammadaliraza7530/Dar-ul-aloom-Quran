  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-muted-foreground">{ur ? "اکیڈمی کی طرف سے اہم پیغامات اور اعلانات" : "Important messages and updates from the academy"}</p>
      </div>
      ...
      <div className="grid gap-4">
        {isLoading ? (
          ...
          announcements?.map((item) => (
            <div key={item.id} className="rounded-lg border border-border bg-card p-6 shadow-sm flex gap-4">
