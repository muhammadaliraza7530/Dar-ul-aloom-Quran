...
function ContactPage() {
  ...
  return (
    <>
      <PageHero title="Contact us" urdu="ہم سے رابطہ کریں" description="Ask about courses, timings or fees — we usually reply the same day." />
          ...
          <div className="space-y-6">
            <div className="flex gap-4 border border-border bg-card p-6 shadow-sm">
              ...
              <div>
                ...
                <a className="text-sm text-muted-foreground hover:text-gold-dark" href={`mailto:${contact.email}`}>{contact.email}</a>
              </div>
            </div>
            <div className="flex gap-4 border border-border bg-card p-6 shadow-sm">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground" dir="ltr">{contact.phonePrimary}</p>
                <p className="text-sm text-muted-foreground" dir="ltr">{contact.phoneSecondary}</p>
              </div>
            </div>
            <div className="flex gap-4 border border-border bg-card p-6 shadow-sm">
